...
%%% Train a classifier
trainedClassifier = fitcknn(predictors, response, 'PredictorNames', {'Dementia' 'Duration' 'Frequency'}, 'ResponseName', 'Expert2cat', 'ClassNames', [0 1], 'Distance', 'Minkowski', 'Exponent', 3, 'NumNeighbors', k, 'DistanceWeight', 'Equal', 'StandardizeData', 1);
