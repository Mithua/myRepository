...
%%% Train a classifier
trainedClassifier = fitcsvm(predictors, response, 'KernelFunction', 'linear', 'PolynomialOrder', [], 'KernelScale', 'auto', 'BoxConstraint', C, 'Standardize', 1, 'PredictorNames', {'Dementia' 'Duration' 'Frequency'}, 'ResponseName', 'Expert2cat', 'ClassNames', [0 1]);
%%% Perform 10-fold CV
