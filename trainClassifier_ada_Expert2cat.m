...
%%% Train a classifier
trainedClassifier = fitensemble(predictors, response, 'AdaBoostM1', cy, 'Tree', 'Type', 'Classification', 'LearnRate', 0.1, 'PredictorNames', {'Duration' 'Frequency'}, 'ResponseName', 'Expert2cat', 'ClassNames', [0 1]);
%%% Perform 10-fold CV
